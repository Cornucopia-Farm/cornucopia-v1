    ...
    <Card className={styles.cardBackground} sx={{ minWidth: '275', borderRadius: '12px', }}>
      <CardContent>
        <Box sx={{ display: 'flex', flexDirection: 'column', paddingLeft: '1px', paddingRight: '1px', paddingTop: '1px', }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', paddingLeft: 0, paddingBottom: 1,}}> 
            <Typography className={styles.cardTag} sx={{ fontSize: 16, color: '#064829', }}>End Date </Typography>
            <Typography className={styles.cardInfo} sx={{fontSize: 16, color: '#064829', }}>{dayjs(props.endDate).format('MM-DD-YYYY')}</Typography>
          </Box>
          <Box sx={{ display: 'flex', flexDirection: 'column', paddingLeft: 0, paddingBottom: 1, }}> 
          ...
          <Box sx={{ display: 'flex', paddingLeft: 0}}> 
            ...
            <Typography className={styles.arweaveHash} sx={{fontSize: 16, color: '#064829', width: '45%', overflow: 'auto', scrollbarWidth: 'none', '&::-webkit-scrollbar': { display: 'none', }, }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', paddingLeft: 0, ...(props.finishedStatus?.normalPayout === false && { paddingBottom: 1, }), }}> 
            ...
            <Typography className={styles.arweaveHash} sx={{fontSize: 16, color: '#064829', overflow: 'auto', scrollbarWidth: 'none', '&::-webkit-scrollbar': { display: 'none', }, }}>
              <Link sx= {{ color: 'rgb(233, 233, 198)'}} target="_blank" rel="noopener" href={"https://arweave.net/" + props.arweaveHash}>{props.arweaveHash}</Link>
            </Typography>
          </Box>
          }
