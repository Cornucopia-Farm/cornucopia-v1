...
export interface CornucopiaInterface extends utils.Interface {
  functions: {
    "DAI_ADDRESS()": FunctionFragment;
    "ORACLE_ADDRESS()": FunctionFragment;
    "ORACLE_STORE_ADDRESS()": FunctionFragment;
    "USDC_ADDRESS()": FunctionFragment;
    "WETH_ADDRESS()": FunctionFragment;
    "bountyAmounts(bytes32)": FunctionFragment;
    "bountyAncillaryData(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ORACLE_STORE_ADDRESS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "bountyAncillaryData",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface Cornucopia extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CornucopiaInterface;
  ...
  functions: {
    DAI_ADDRESS(overrides?: CallOverrides): Promise<[string]>;

    ORACLE_ADDRESS(overrides?: CallOverrides): Promise<[string]>;

    ORACLE_STORE_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    DAI_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;

    ORACLE_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;

    ORACLE_STORE_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    DAI_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
