...
export interface SkinnyOptimisticOracleProdInterface extends utils.Interface {
  functions: {
...
export type DisputePriceEvent = TypedEvent<
  [
    ...
    number,
    string,
    SkinnyOptimisticOracleInterface.RequestStructOutput
  ],
...
export interface SkinnyOptimisticOracleProd extends BaseContract {
  ...
  interface: SkinnyOptimisticOracleProdInterface;
